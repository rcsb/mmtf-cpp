...
c++ -O3 -Wall -Wextra -shared -std=c++17 -fPIC `python3 -m pybind11 --includes` -I../pybind11/include -I../msgpack-c/include -I../include  bindings.cpp -o mmtf_cpp`python3-config --extension-suffix`
